...
const typeOdds = {
  ...
  god: [
    ...
    { odds: -1, item_name: "card_anshu" },
    { odds: -1, item_name: "card_nimbus" },
    { odds: -1, item_name: "card_legion" },
    { odds: -1, item_name: "card_aghanim" },
    { odds: -1, item_name: "card_lifestealer" },
    { odds: -1, item_name: "card_kanna" },
    { odds: -1, item_name: "card_ogre" },
    { odds: -1, item_name: "card_rix" },
    { odds: -1, item_name: "card_gambler" },
    { odds: -1, item_name: "card_pa" },
    { odds: -1, item_name: "card_alchemist" },
    { odds: -1, item_name: "card_rune" },
    { odds: -1, item_name: "card_sorla" },
  ],
