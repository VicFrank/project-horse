...
<ul>
  <li>
Replaced the God chest with a new Galaxy God Chest 1. This chest will act similarly to  regular Dota chests. This version will have 12 Gods +  3 Rares with escalating odds. You will not get a duplicate God untless you have all the non rares.
</li></ul>
...
<li>Type: Passive</li>
<li>An automatic gift exchange will give you a Good Gift or Bad Gift depending on if you win or not. Opposing player can accept/decline their gift during the early stages of the battle.</li>
</ul>
<li>Added Chaos God Season 3 (unlocked via Battlepass)</li>
  <ul>
<li>Ability: ?</li>
<li>Type: Passive</li>
<li>First re-roll is always free, spells sell for full value, and hero re-rolls are less gold.</li>
</ul>
...
<li>Added Boneless Aghanim God to replace the old Lifestealer (unlocked via chest)</li>
<ul>
<li>Ability: Sorcery For Dummies: Volume 3</li>
<li>Type: Passive</li>
<li>Ultimates never enter your pool of spells. Shop scales differently than other Gods.</li>
</ul>
<li>Added a completely reworked Lifestealer God (Free to all)</li>
<ul><li>Ability: Infest</li>
<li>Type: Active</li>
<li>Once selected unit is low, they will jump inside a random enemy, dealing physical attacks and healing dramatically. Once it exits, it deals damage in an area.</li>
</ul>
<li>Added Cave Johnson God (unlocked as a Rare in the Galaxy God Chest)</li>
<ul><li>Ability: Mantis Radiation</li>
<li>Type: Passive</li>
<li>Your heroes cannot heal, but they gain buffs based on their primary attribute.</li>
</ul>
<li>Added Bathtime Aghanim God (unlocked as a Very Rare in the Galaxy God Chest)</li>
<ul><li>Ability: Sorcery For Dummies: Volume 4</li>
<li>Type: Passive</li>
<li>Every round a random ability is upgraded to the next threshold temporarily. Amount of spells upgraded scales with shop level.</li>
</ul>
<li>Added Techies God (unlocked as an Ultra Rare in the Galaxy God Chest)</li>
<ul><li>God is split into three abilities, belonging to Squee, Spleen, and Spoon respectively. All three abilities can be cast on the same unit. Level 2/4/5 unlocks a random member of the team.</li>
<li>Ability: Squee's Sticky Bomb</li>
<li>Type: Active</li>
<li>Doing enough spell damage will apply a Sticky Bomb to the enemy.</li>
...
<li>Ogre Magi spell point requirement from 0/25/50/75/100 to 0/20/40/60/80</li>
<li>Phantom Assassin critical strike chance from 15% to 20%</li>
<li>Rubick spell points required from 0/11/22/33/44/55/66/77/88 to 0/10/20/30/40/50/60/70/80</li>
...
<li>Black Hole AI changed to cast on closest unit instead of searching for multi-target</li>
<li>Blink now has the silence/damage from Super by default</li>
<li>Boundless Strike Super fixed to not deal double damage to the middle target</li>
<li>Brain Sap Super additionally adds +Health to the unit equivalent to the amount sapped</li>
<li>Burrowstrike Super additionally increases cast range to 1300, grants 2s cooldown reduction, and +0.3 second stun duration</li>
<li>Burrowstrike Super Caustic Finale base damage increased from 130 to 230. Duration increased from 5 to 12</li>
...
<li>Corrosive Haze Super replaced with: now allows Corrosive Haze to stack on the unit. Remove the healing reduction</li>
...
<li>Demonic Cleanse (Demonic Purge Gaben) fixed to cost 50 mana instead of 150</li>
...
<li>Dragon Slave Super additionally deals 50 extra damage per unit it hits</li>
<li>Duel cast ranged reduced by 500 (to regular Dota numbers)</li>
<li>Duel duration from 4/6/8 to 5/6/7</li>
<li>Duel Super replaced with: 10 Duel damage per duel, +500 cast range, +1s duration, -20s CD</li>
...
<li>Eye of the Storm Super additionally grants Lightning Rod: caster also gets hit by Eye of the Storm, gaining the opposite effects (healing and +armor) for half value.</li>
...
<li>Fiends Grip Super replaced with: "Additionally deals 5% HP per second"</li>
<li>Flesh Golem strength multiplier from 40/50/60% to 30/40/50%</li>
<li>Flesh Golem Super additionally grants +10% damage amp and +10% strength multiplier</li>
<li>Fortunes End now has its normal Dota channel time</li>
<li>Glaives of Wisdom fixed to not work with 0 mana</li>
<li>Iceblast Super additionally will cast  Ice Vortex on the ground below the target</li>
<li>Jingu Gaben soldiers now have +400 attack range</li>
<li>Leech Seed additional Super: Leech Seed becomes a puddle that leech seeds from every unit standing in it</li>
<li>Life Break Super additionally adds: every unit hit in the path of the Life Break takes 100% of caster's self-damage as magical</li>
<li>Poison Attack Super now additionally leeches Magic Resistance (grants stolen magic resist to attacker)</li>
<li>Purification cast range increased from 550 to 800</li>
<li>Purification Super additionally grants Gaben's Blessing: casts 2 more Purifications on the same unit, seperated by 3s intervals</li>
...
<li>Reality Rift Super additionally casts level 2 Chaos Bolt on target</li>
<li>Reality Rift Gaben Chaos Bolt additionally summons a Phantasm Illusion on target hit</li>
<li>Resonant Pulse Super additionally: grants 1s of Magic Immunity for every unit hit</li>
...
<li>Static Link Gaben replaced with steals attack speed as well, and duration still lasts the entire round</li>
...
<li>Trample Super grants 20% magic resist while trampling and -5s CDR</li>
<li>Walrus Punch cooldown from 36/24/12s to 20/15/10s</li>
<li>Walrus Punch manacost from 50/75/100 to 75</li>
<li>Walrus Punch Super additionally removes manacost and reduces cooldown by 4s</li>
...
<ul>
<li>Battlepass Season 3 released! Here are the highlighted features:</li>
...
<li>Win Streaks added (Fire is in store and Santa Greevil is in Battlepass). These streaks have 3 levels of intensity for winning 3/6/9 rounds in a row.</li>
<li>God Chests have been deleted and replaced with the Galaxy God Chest 1. More info regarding how we are doing future chests will be in the dev blog.</li>
<li>War Chests can now drop multiple items (up to 5).</li>
<li>Temporary PLUS memberships and God chests can no longer drop from War Chests</li>
